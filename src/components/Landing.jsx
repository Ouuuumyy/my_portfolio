  ...
  return (
    ...
    >
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-[43px] md:text-5xl  font-playfair z-10 text-center md:text-start">
            Oumaima {""}
            <span
              className="xs:relative text-red lg:text-deep-blue before:hidden before:lg:block xs:font-semibold z-20 xs:before:content-brush
        ...
        >
          ...
          <a className="rounded-r-sm bg-gradient-rainblue py-0.5 pr-0.5"
